...
def imprimir_nombre():
    print("Jaime Carriel")# Aquí se imprime el nombre en la pantalla
...
if __name__ == "__main__":
    resultado = suma_1_al_10()  # Se llama a la función suma_1_al_10() para obtener el resultado # Se imprime el resultado de la suma
...
if __name__ == "__main__":
    ...
    radio=area_circulo(radio)# Se imprime el área calculada del círculo
...
if __name__ == "__main__":
    ...
    num2= int(input("Ingresa el segundo numero: "))# Se solicita al usuario que ingrese el segundo número
